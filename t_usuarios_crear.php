        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <form action="query/q_usuario_crear.php" name="form56" method="post" enctype="multipart/form-data" >
                        <fieldset>
                            <!-- Form Name -->
                            <legend>Usuarios > Crear</legend>
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="Correo_usuario:">Correo/usuario:</label>
                                <div class="col-md-4">
                                    <input id="correo_usuario" name="correo_usuario" type="text" placeholder="correo usuario" class="form-control input-md"
                                           value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input id="nombre_usuario" name="nombre_usuario" type="text" placeholder="nombres" class="form-control input-md"  value="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select name='id_perfil' class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="pass1" min="6" max="10" id="pass1" type="password" placeholder="Clave" class="form-control input-md"
                                           value="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="pass2" min="6" max="10" id="pass2" type="password" placeholder="Vuelva a escribir la contraseña" class="form-control input-md">
