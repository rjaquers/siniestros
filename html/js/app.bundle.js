				...
				switch ( true ) {
					...
					case ( actiontype === 'panel-close' ):
						...
						if (typeof bootbox  != 'undefined') {
							...
							bootbox.confirm({
								title: "<i class='fal fa-times-circle text-danger mr-2'></i> Desea ocultar este panel <span class='fw-500'>&nbsp;'" +selectedPanel.children('.panel-hdr').children('h2').text().trim()+ "'&nbsp;</span>?",
								message: "<span><strong>Alerta:</strong> Debe refrescar la página para volver a mostrarlo!</span>",
								centerVertical: true,
								swapButtonOrder: true,
								buttons: {
									confirm: {
