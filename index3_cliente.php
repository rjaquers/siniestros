...
<head>
    <meta charset="utf-8">
    <title>
        Page Titile - category_1 - Siniestros HyV v4.0.2
    </title>
        ...
        <aside class="page-sidebar">
            <div class="page-logo">
                <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                    ...
                    <span class="page-logo-text mr-1">WebApp Foto Siniestros</span>
        ...
        <div class="page-content-wrapper">
                ...
                <div class="ml-auto d-flex">
                    ...
                    <div>
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                            ...
                            <div class="dropdown-divider m-0"></div>
                            <a class="dropdown-item fw-500 pt-3 pb-3" href="exit.php">
            ...
            <main id="js-page-content" role="main" class="page-content">
                <ol class="breadcrumb page-breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">Siniestros HyV</a></li>
            ...
            <footer class="page-footer" role="contentinfo">
                <div class="d-flex align-items-center flex-1 text-muted">
                    <span class="hidden-md-down fw-700">2019 © Siniestros HyV by&nbsp;<a href='https://www.gotbootstrap.com' class='text-primary fw-500' title='gotbootstrap.com' target='_blank'>gotbootstrap.com</a></span>
                </div>
                <div>
