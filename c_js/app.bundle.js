 ...
 *
 * Copyright 2019, 2020 WebApp Foto Siniestros
				...
				switch ( true ) {
					...
					case ( actiontype === 'panel-close' ):
						...
						if (typeof bootbox  != 'undefined') {
							...
							bootbox.confirm({
								title: "<i class='fal fa-times-circle text-danger mr-2'></i> Desea ocultar este panel de control <span class='fw-500'>&nbsp;'" +selectedPanel.children('.panel-hdr').children('h2').text().trim()+ "'&nbsp;</span>?",
								message: "<span><strong>Alerta:</strong>Debe refrescar la página para volver a verlo.!</span>",
								centerVertical: true,
								swapButtonOrder: true,
								buttons: {
									confirm: {
							...
							if (confirm( 'Desea ocultar este panel de control ' + selectedPanel.children('.panel-hdr').children('h2').text().trim() + '?' )) {
								killPanel();
							}
