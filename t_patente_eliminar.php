<?php
require_once("query/q_patente_x_id.php");
?>
        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <form action="query/q_patente_borrar.php" name="borrar registros" method="post" enctype="multipart/form-data" accept-charset="x-iso-8859-11">
                                                            ...
                                                            <span class="h2">
                                                             ¿  Está seguro que desea eliminar este registro?
                                                                <h3 class="text-white   text-nowrap">
                                                                   <?php echo $row_patente_x_id['patente']; ?>
                                                                </h3>
                        ...
                        <input type="hidden" name="id_formulario" value="104">
